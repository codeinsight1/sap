sap.ui.jsview("salesmapAPF1d2.controls.view.exchangeRate", {
	getControllerName : function() {
		return "salesmapAPF1d2.controls.controller.exchangeRate";
	},
	createContent : function(oController) {
		...
		var oDatePicker = new sap.m.DatePicker({
			placeholder : self.oApi.getTextNotHtmlEncoded("enterDate"),
			width : "100%",
			enabled : false,
			editable : false,
			value : '{/sSelectedDate}'
